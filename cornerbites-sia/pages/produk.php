...
try {
    ...
    $query = "SELECT id, name, unit, cost_price, sale_price, stock FROM products " . $whereClause . " ORDER BY name ASC LIMIT :limit OFFSET :offset";
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900">Tambah / Edit Produk</h3>
                            <p class="text-sm text-gray-600 mt-1">Isi detail produk baru Anda atau gunakan form ini untuk mengedit produk yang sudah ada.</p>
                        </div>
                    </div>
                    ...
                    <form action="/cornerbites-sia/process/simpan_produk.php" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                <label for="cost_price" class="block text-sm font-semibold text-gray-700 mb-2">Harga Beli (Rp):</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <span class="text-gray-500 text-sm font-medium">Rp</span>
                                    </div>
                                    <input type="text" id="cost_price_display" class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="Masukkan harga beli" oninput="formatRupiah(this, 'cost_price')">
                                    <input type="hidden" id="cost_price" name="cost_price" required>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="flex items-end gap-2">
                                    <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.207A1 1 0 013 6.5V4z"></path>
                                        </svg>
                                        Filter
                                    </button>
                                    <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Harga Beli (Rp)</th>
                                    ...
                                    <?php if (!empty($products)): ?>
                                        <?php foreach ($products as $product): ?>
                                            <tr class="hover:bg-gray-50 transition duration-150">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-semibold text-gray-900">Rp <?php echo number_format($product['cost_price'], 0, ',', '.'); ?></div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
