        ...
        <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <div class="w-2 h-8 bg-gradient-to-b from-teal-500 to-teal-600 rounded-full mr-4"></div>
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Manajemen Bahan Baku & Kemasan</h1>
                        <p class="text-sm text-gray-600 mt-1">Kelola stok dan harga bahan baku serta kemasan produk Anda</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="flex items-center text-right">
                        <span class="text-sm text-gray-500">Total: </span>
                        <span class="text-lg font-bold text-teal-600 ml-1"><?php echo number_format($totalRawMaterialsRows + $totalPackagingMaterialsRows); ?> item</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <main class="flex-1 p-6 overflow-y-auto">
            <div class="container mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                    <h2 class="text-xl font-bold text-gray-800 mb-4" id="form-title">Tambah Bahan Baku/Kemasan Baru</h2>
                ...
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="flex items-center bg-blue-50 px-3 py-2 rounded-lg">
                                <span class="text-sm font-medium text-blue-600">
                                    Total: <span class="font-bold"><?php echo $totalRawMaterialsRows; ?> bahan</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-4 mb-6">
                            <div class="flex-1 relative">
                                <input type="text" id="search_raw" placeholder="Cari nama bahan..." value="<?php echo htmlspecialchars($searchQueryRaw); ?>" class="w-full pl-4 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            </div>
                            <div class="flex items-center space-x-2">
                                <select id="bahan_limit" class="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                ...
                                <button id="filter_raw_btn" class="px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"></path>
                                    </svg>
                                    Filter
                                </button>
                                <button id="reset_raw_btn" class="px-4 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="flex items-center bg-green-50 px-3 py-2 rounded-lg">
                                <span class="text-sm font-medium text-green-600">
                                    Total: <span class="font-bold"><?php echo $totalPackagingMaterialsRows; ?> kemasan</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-4 mb-6">
                            <div class="flex-1 relative">
                                <input type="text" id="search_kemasan" placeholder="Cari nama kemasan..." value="<?php echo htmlspecialchars($searchQueryPackaging); ?>" class="w-full pl-4 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            </div>
                            <div class="flex items-center space-x-2">
                                <select id="kemasan_limit" class="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                ...
                                <span class="text-sm text-gray-500">Per Halaman</span>
                                <button id="filter_kemasan_btn" class="px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"></path>
                                    </svg>
                                    Filter
                                </button>
                                <button id="reset_kemasan_btn" class="px-4 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                                    </svg>
                                    Reset
